...
4. [Configuration and Setup](#configuration-and-setup)
   ...
   - [Step 3: Setting Up Bedrock Agent and Action Group](#step-3-setup-bedrock-agent-and-action-group)
   - [Step 4: Testing Various Models](#step-4-test-various-models)
...
- Now we will Install the serverless-python-requirements Plugin: The serverless-python-requirements plugin helps manage Python dependencies for your Serverless project. Install it by running: 
  ...
  ***(BEFORE RUNNING THE ABOVE COMMAND, DOCKER ENGINE WILL NEED TO BE INSTALLED AND RUNNING. MORE INFORMATION CAN BE FOUND [HERE](https://docs.docker.com/engine/install/) )***
