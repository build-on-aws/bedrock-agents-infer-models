...
- Select the checkbox next to the Base models "Amazon" and "Anthropic". This will auto select all of the required models. After, scroll down to the bottom right and select “Request model access”. 
